      ...
      <div className="lg:w-[1190px] w-full flex flex-col justify-center items-center">
        {!content ? (
          <div className="flex items-center gap-5">
            <p className="p-4 text-base text-blue-600 uppercase cursor-pointer font-medium">
              Line Graph
            </p>
            <p
          ...
          <div className="flex items-center gap-5">
            ...
            <p className="p-4 text-base text-blue-600 uppercase ursor-pointer font-medium">
              Leaflet Map
            </p>
          </div>
        )}
